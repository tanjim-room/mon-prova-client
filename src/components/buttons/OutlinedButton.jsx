...
const OutlinedButton = ({ text, extraClass, icon }) =>{
  return (
    <motion.button
      ...
      className={`relative px-8 py-3 font-semibold text-[#1998df] border-2 border-[#007AF5] rounded-lg shadow-md bg-transparent transition-all duration-100 hover:text-white hover:bg-[#007AF5] hover:border-none ${extraClass}`}  >
